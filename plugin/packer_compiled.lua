...
_G.packer_plugins = {
  ...
  ["feline.nvim"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/feline.nvim",
  ...
  ["github-nvim-theme"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/github-nvim-theme",
  ...
  ["nvim-fzf"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/nvim-fzf",
  ...
  ["vim-endwise"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-endwise",
  ...
  ["vim-obsession"] = {
    loaded = true,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/start/vim-obsession",
  ...
  ["vim-rails"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/admin/.local/share/nvim/site/pack/packer/opt/vim-rails",
